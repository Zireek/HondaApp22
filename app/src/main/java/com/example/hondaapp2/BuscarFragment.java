...
public class BuscarFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @NonNull Bundle savedInstanceSrate) {
        ...
        irh = view.findViewById(R.id.irh);
        irg = view.findViewById(R.id.irg);
        irs = view.findViewById(R.id.irs);

        irh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_buscarFragment_to_hibridoFragment2);
            }
        });
        irg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_buscarFragment_to_gasolinaFragment2);
            }
        });
        irs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_buscarFragment_to_motosupersportFragment2);
            }
        });
    }
