 ...
 * Use the {@link enviadoFragment#newInstance} factory method to
...
public class enviadoFragment extends Fragment {
     ...
     * @return A new instance of fragment enviadoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static enviadoFragment newInstance(String param1, String param2) {
        enviadoFragment fragment = new enviadoFragment();
    ...
    public void onViewCreated(@NonNull View view, @NonNull Bundle savedInstanceSrate) {
        ...
        botonvolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_enviadoFragment_to_homeFragment);
            }
        });
